...
/**
 * Parked from the original mode home pages. Not currently rendered anywhere —
 * preserved as a "complete product" example we can wire back in later (e.g.
 * as its own route, a /showcase page, or a fourth mode).
 */
