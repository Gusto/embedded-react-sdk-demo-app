      ...
      >
        <span className="relative mt-0.5 inline-flex shrink-0">
          <input
            ...
            className={`peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 bg-white transition-colors checked:border-blue-500 checked:bg-blue-500 disabled:cursor-not-allowed ${
